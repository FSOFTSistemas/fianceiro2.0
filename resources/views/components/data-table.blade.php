...
@section('css')
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/.min.css" rel="stylesheet">
...
@section('js')
    ...
    <script>
        ...
        var table = $('#{{ $uniqueId }}').DataTable({
            ...
            ], // Adiciona a ordenação dinâmica aqui
        ...
        function calculateTotal() {
            ...
            table.rows({
                ...
                let data = this.data();
                let value = data[valueColumnIndex];

                if (typeof value === 'string') {
                    // Remove somente R$, espaços e outros caracteres não numéricos, mas mantém ponto e vírgula
            ...
            $('#total').html('<strong>R$ ' + total.toLocaleString('pt-BR', {
